 ...
 * display behaviours of the LCD on the EV3 platform. The class implements the
 * {@code Runnable} interface and has a {@code run()} method
 */
public class Display implements Runnable {
	...
	/**
	 * This is the class constructor which initializes the odometer and the LCD
	 * display.
	 * 
